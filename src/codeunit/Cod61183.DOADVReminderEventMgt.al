codeunit 61183 "DOADV Reminder Event Mgt"
{
    ...
    var
        ReminderFunctions: Codeunit "DOADV DC Approval Notif. Mgt.";
    begin
    ...
    [BusinessEvent(false)]
    procedure OnBeforeProcessApprovalEntryRow(ApprovalEntry: Record "Approval Entry"; var TableRowTemplate: Text; PurchaseHeader: Record "Purchase Header"; var Handled: Boolean; var Success: Boolean)
    begin
    end;
}
